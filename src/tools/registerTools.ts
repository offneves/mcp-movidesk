...
import { z } from "zod";
import { getTicketContext } from "./getTicketContext.js";
import { getTicketResume } from "./getTicketResume.js";
...
export function registerTools(server: McpServer) {
    ...
    server.tool(
        ...
        async (args) => {
            ...
            try {
                const result = await getTicketResume({
                    ...args,
                    baseUrl,
                    username,
                    password,
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: `Error getting ticket resume: ${errorMessage}`,
                        },
                    ],
                    isError: true,
                };
